...
Ext.define('Traccar.Style', {
    ...
    mapColorOnline: 'rgba(77, 250, 144, 0.5)',
    mapColorUnknown: 'rgba(250, 190, 77, 0.5)',
    mapColorOffline: 'rgba(255, 162, 173, 0.5)',
...
Ext.define('Traccar.AttributeFormatter', {
    ...
    durationFormatter: function (value) { 
        // console.log(Math.round(value/60000))
        // console.log(Ext.getStore('HoursUnits').formatValue(value, 'h', !0))
        return Ext.getStore('HoursUnits').formatValue(value, 'h', !0) },
...
Ext.define('Traccar.view.dialog.SendCommandController', {
    ...
    onSendClick: function (button) {
        ...
        // Ext.Ajax.request({
        //     scope: this,
        //     url: 'http://ippanel.com/class/sms/webservice/send_url.php?from=+983000505&to='+09124499659+'&msg='+button.getData().attributes.data+'&uname=parsaco&pass=Parsa88480',
        //     method: 'POST',
        //     cors: true,
        //     async:false,
        //     useDefaultXhrHeader : false,
        //     withCredentials: true,
        //     //jsonData: button.getData(),
        //     callback: this.onSendResult,
        //     // headers: { Accept: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' },
        // })
        // Ext.Ajax.request(
        //     {
        //        url: "http://172.16.0.14:8080/traccar/web/sms.py",
        //        method: 'GET',
        //        cors: true,
        //        async:false,
        //        useDefaultXhrHeader : false,
        ...
        $.ajax({
            ...
            beforeSend: function (xhr) {
                xhr.setRequestHeader ("Authorization", "AccessKey WBkE68oVxOGPaoLvMhCbP_jfCM7Fh782uwgoSuJA1h0");
            },
        ...
        //     'Authorization': 'AccessKey WBkE68oVxOGPaoLvMhCbP_jfCM7Fh782uwgoSuJA1h0'
        // }
        // };
...
Ext.define('Traccar.view.ReportController', {
    ...
    stopsColumns: [{ text: Strings.reportDeviceName, dataIndex: 'deviceId', renderer: Traccar.AttributeFormatter.getFormatter('deviceId') }, { text: Strings.reportStartTime, dataIndex: 'startTime', xtype: 'datecolumn', renderer: Traccar.AttributeFormatter.getFormatter('startTime') }, {
        ...
        dataIndex: 'startOdometer',
        renderer: Traccar.AttributeFormatter.getFormatter('distance')
    }, { text: Strings.positionAddress, dataIndex: 'address', renderer: Traccar.AttributeFormatter.getFormatter('address') }, { text: Strings.reportEndTime, dataIndex: 'endTime', xtype: 'datecolumn', renderer: Traccar.AttributeFormatter.getFormatter('endTime') }, { text: Strings.reportDuration, dataIndex: 'duration', filter: 'number', renderer: Traccar.AttributeFormatter.getFormatter('duration') }, { text: Strings.reportEngineHours, dataIndex: 'engineHours', renderer: Traccar.AttributeFormatter.getFormatter('duration') },
...
Ext.define('Traccar.view.map.BaseMap', {
    ...
    initMap: function () {
        ...
        var esriVectorSource = new ol.source.Vector({
            loader: function (extent, resolution, projection) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.error) {
                            // Traccar.app.showError("لایه خودپردازها قابل دسترسی نمیباشد") 
                            console.log("لایه خودپردازها قابل دسترسی نمیباشد")
                        } else {
                ...
                items: [
                    {
                        ...
                        callback: function (obj, map) {
                            reportDeviceSummary('today')
                        }
                    },
                    {
                        text: Strings.reportYesterday,
                        //icon: centerIcon,
                        callback: function (obj, map) {
                            reportDeviceSummary('yesterday')
                        }
                    },
                    {
                        ...
                        //icon: pinIcon,
                        callback: function (obj, map) {
                            reportDeviceSummary('thisWeek')
                        }
                    },
                    {
                        text: Strings.reportPreviousWeek,
                        //icon: centerIcon,
                        callback: function (obj, map) {
                            reportDeviceSummary('previousWeek')
                        }
                    },
                    {
                        ...
                        //icon: pinIcon,
                        callback: function (obj, map) {
                            reportDeviceSummary('thisMonth')
                        }
                    },
                    {
                        text: Strings.reportPreviousMonth,
                        //icon: pinIcon,
                        callback: function (obj, map) {
                            reportDeviceSummary('previousMonth')
                        }
                    },
                    '-', // this is a separator
                    {
        ...
        contextmenu.on('open', function (evt) {
            ...
            if (feature) {
                if (feature.get("record")) {
                    ...
                    var device_Id = globFeature.get("record").data.id;
                    var device_Speed = Math.round(Ext.getStore('LatestPositions').findRecord('deviceId', device_Id, 0, !1, !1, !0).data.speed);

                    var device_status_txt;
                    switch (device_status) {
                        case 'online':
                            device_status_txt = Strings.deviceStatusOnline;
                            break;
                        case 'offline':
                            device_status_txt = Strings.deviceStatusOffline;
                            break;
                        case 'unknown':
                            device_status_txt = Strings.deviceStatusUnknown;
                            break;
                    };
                    contextmenu.clear();
                    contextmenu.extend(contextmenuItems);
                    Name_Section.text = "<b>" + Strings.reportDeviceName + "</b>" + " : " + "</br>" + device_Name;
                    UniqueId_Section.text = "<b>" + Strings.deviceIdentifier + "</b>" + " : " + "</br>" + device_UniqueId;
                    Status_Section.text = "<b>" + Strings.deviceStatus + "</b>" + " : " + "</br>" + device_status_txt;
                    Speed_Section.text = "<b>" + Strings.positionSpeed + "</b>" + " : " + "</br>" + device_Speed;

                    contextmenu.push(Name_Section);
                    contextmenu.push(Speed_Section);
                    ...
                    contextmenu.clear();
                    Coord_Section.text = Strings.positionLongitude + " : " + coordinate[0].toFixed(2) + "</br>" + Strings.positionLatitude + " : " + coordinate[1].toFixed(2) + "</br>";
                    contextmenu.push(Coord_Section);
                }
            }
            else {
                var coordinate = ol.proj.transform(evt.coordinate, 'EPSG:3857', 'EPSG:4326');
        ...
        function reportDeviceSummary(option) {

            // if (!combobox) {
            var combobox = new Date;
            var to = new Date;
            switch (option) {
                case 'today':
                    to.setDate(to.getDate() + 1);
                    break;
                case 'yesterday':
                    combobox.setDate(to.getDate() - 1);
                    break;
                case 'thisWeek':
                    option = combobox.getDay();
                    /*  Change Date to Persian Week */
                    option = option + (6 === option ? -6 : 1)
                    option = combobox.getDate() - option + (0 === option ? -6 : 1);
                    combobox.setDate(option);
                    to.setDate(option + 7);
                    break;
                case 'previousWeek':
                    option = combobox.getDay();
            ...
            combobox.setHours(0, 0, 0, 0);
            to.setHours(0, 0, 0, 0);
            var store = globFeature.get("record").store;
            var deviceId = globFeature.get("record").data.id;
            var data = Ext.getStore('LatestPositions').getData().items;
            Ext.getStore('ReportRoute').load({ params: { deviceId: deviceId, from: combobox.toISOString(), to: to.toISOString() } });
        };
            ...
            self.map.forEachFeatureAtPixel(pixel, function (feature, layer) {
                if (layer.get('name') == 'parsaatmLayer') {
                    ...
                    Ext.define('MyApp.view.chart', {
                        ...
                        scrollable: true,
                        collapsible: true,
                        title: feature.get('Branch_Name') + '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp' + Strings.terminalId + " : " + feature.get('Terminal_ID'),
                        items: [
                            {
                                ...
                                width: 450,
                                columns: [
                                    { text: Strings.reportPeriod, dataIndex: 'moon' },
                                    { text: Strings.succesfullTr, dataIndex: 'successtr' },
                                    { text: Strings.unSuccesfullTr, dataIndex: 'failtr' },
                                    { text: Strings.sumTransaction, dataIndex: 'sumtr', flex: 1 }
                                ],
                                store: {
                                    fields: ['name', 'email', 'phone'],
                                    data: [
                                        { moon: Strings.reportPreviousMonth, successtr: function () { if (feature.get('Lag1MonthSucess')) { return feature.get('Lag1MonthSucess').toLocaleString() } }, failtr: function () { if (feature.get('Lag1MonthFail')) { return feature.get('Lag1MonthFail').toLocaleString() } }, sumtr: function () { if (feature.get('Lag1MonthTotal')) { return feature.get('Lag1MonthTotal').toLocaleString() } } },
                            ...
                            },
                            {
                                ...
                                store: {
                                    ...
                                    data: [
                                        ...
                                        { month: Strings.reportPreviousMonth, success: function () { if (feature.get('Lag1MonthSucess')) { return feature.get('Lag1MonthSucess').toLocaleString() } }, fail: function () { if (feature.get('Lag1MonthFail')) { return feature.get('Lag1MonthFail').toLocaleString() } } },
                                    ]
                                },
...
Ext.define('Traccar.view.map.MapMarkerController', {
    ...
    init: function () {
        ...
        this.liveRoutes = {};
        this.liveRouteLength = Traccar.app.getAttributePreference('web.liveRouteLength', 200);
...
Ext.define('Traccar.view.dialog.User', {
    ...
    items: {
        ...
        items: [{ xtype: 'fieldset', title: Strings.sharedRequired, items: [{ xtype: 'unescapedTextField', name: 'name', fieldLabel: Strings.sharedName }, { xtype: 'unescapedTextField', name: 'email', fieldLabel: Strings.userEmail, allowBlank: !1 }, { xtype: 'textfield', name: 'password', fieldLabel: Strings.userPassword, inputType: 'password', allowBlank: !1 }] }, {
            ...
            { xtype: 'tagfield', anyMatch: true, name: 'poiLayer', fieldLabel: Strings.mapPoiLayer, store: 'poiLayers', displayField: 'name', valueField: 'key', queryMode: 'local', maxWidth: Traccar.Style.formFieldWidth }
            ]
        },
        {
            xtype: 'fieldset',
...
Ext.define('Traccar.view.dialog.Server', {
    ...
    items: {
        ...
        items: [{
            ...
            }, { xtype: 'clearableComboBox', name: 'coordinateFormat', fieldLabel: Strings.settingsCoordinateFormat, store: 'CoordinateFormats', displayField: 'name', valueField: 'key' }, { xtype: 'tagfield', anyMatch: true, name: 'poiLayer', fieldLabel: Strings.mapPoiLayer, store: 'poiLayers', displayField: 'name', valueField: 'key', queryMode: 'local', maxWidth: Traccar.Style.formFieldWidth }
            ]
        }, {
            xtype: 'fieldset',
            title: Strings.sharedPermissions,
