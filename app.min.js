        ...
        contextmenu.on('open', function (evt) {
            ...
            if (feature) {
                if (feature.get("record")) {
                    ...
                    UniqueId_Section.text = "شماره سریال دستگاه : " + "</br>" + device_UniqueId;
                    Name_Section.text = "نام دستگاه :  " + "</br>" + device_Name;
                    Status_Section.text = "وضعیت دستگاه : " + device_status;
                    ...
                    if (self.lookupReference('deviceFollowButton').pressed == true) {
                        contextmenuItems[0].text = "عدم دنبال کردن دستگاه ها"
                    }
                    else if (self.lookupReference('deviceFollowButton').pressed == false) {
                        contextmenuItems[0].text = "دنبال کردن دستگاه"
                    }
                }
                else {
                    var coordinate = ol.proj.transform(evt.coordinate, 'EPSG:3857', 'EPSG:4326');
                    contextmenu.clear();
                    empty_Section.text = "طول جغرافیایی : " + coordinate[0].toFixed(2) + "</br>" + "عرض جغرافیایی : " + coordinate[1].toFixed(2) + "</br>";
